...
import com.abhrainc.fulfilmentprocess.actions.consignment.OrderDispatchedEvent;
 ...
 *
 */
public class OrderDispatchedEventListener extends AbstractAcceleratorSiteEventListener<OrderDispatchedEvent>
{
	...
	@Override
	protected SiteChannel getSiteChannelForEvent(final OrderDispatchedEvent event)
	{
	 ...
	 */
	@Override
	protected void onSiteEvent(final OrderDispatchedEvent event)
	{
		// YTODO Auto-generated method stub
		...
		final ConsignmentProcessModel consignmentProcessModel = getBusinessProcessService().createProcess(
				"orderDispatchedEmailProcess-" + consignmentModel.getCode() + "-" + System.currentTimeMillis(),
				"orderDispatchedEmailProcess");
