...
import com.abhrainc.fulfilmentprocess.actions.consignment.OrderDeliveredEvent;
 ...
 *
 */
public class OrderDeliveredEventListener extends AbstractAcceleratorSiteEventListener<OrderDeliveredEvent>
{
	...
	@Override
	protected SiteChannel getSiteChannelForEvent(final OrderDeliveredEvent event)
	{
	 ...
	 */
	@Override
	protected void onSiteEvent(final OrderDeliveredEvent event)
	{
		// YTODO Auto-generated method stub
		...
		final ConsignmentProcessModel consignmentProcessModel = getBusinessProcessService().createProcess(
				"orderDelieveredEmailProcess-" + consignmentModel.getCode() + "-" + System.currentTimeMillis(),
				"orderDelieveredEmailProcess");
