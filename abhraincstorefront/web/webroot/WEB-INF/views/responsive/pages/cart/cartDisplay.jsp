...
<c:if test="${not empty cartData.entries}">
    ...
    <div class="row cart-actions">
        <div class="col-sm-6 col-md-3 col-md-push-6">
            <button class="btn btn-default btn-block continueShoppingButton" data-continue-shopping-url="${continueShoppingUrl}">
            	<spring:theme text="Continue Shopping" code="cart.page.continue"/>
            </button>
        </div>
        <div class="col-sm-6 col-md-3 col-md-push-6">
            <ycommerce:testId code="checkoutButton">
                <button class="btn btn-primary btn-block checkoutButton continueCheckout" data-checkout-url="${checkoutUrl}">
