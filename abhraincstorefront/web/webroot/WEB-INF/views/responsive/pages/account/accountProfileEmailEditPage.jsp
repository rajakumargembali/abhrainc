...
<div class="account-section-header"><spring:theme code="text.account.update.email.address"/></div>
<div class="account-section-content col-md-6">
	<form:form action="update-email" method="post" commandName="updateEmailForm" class="account-section-form">
