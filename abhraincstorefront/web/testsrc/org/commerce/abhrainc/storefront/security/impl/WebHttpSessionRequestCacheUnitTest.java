...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/abhraincstorefront/electronics/en",
						"https://electronics.local:9002/abhraincstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/abhraincstorefront/electronics/en",
						"https://electronics.local:9002/abhraincstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/abhraincstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/abhraincstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/abhraincstorefront/electronics/en",
						"https://electronics.local:9002/abhraincstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/abhraincstorefront",
						"https://electronics.local:9002/abhraincstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/abhraincstorefront",
						"https://electronics.local:9002/abhraincstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/abhraincstorefront/electronics/en",
						"https://electronics.local:9002/abhraincstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
