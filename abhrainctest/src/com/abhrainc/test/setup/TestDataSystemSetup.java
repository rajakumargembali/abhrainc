 ...
 *  
 */
package com.abhrainc.test.setup;
...
import com.abhrainc.test.constants.AbhraincTestConstants;
import com.abhrainc.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AbhraincTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/abhrainctest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/abhrainctest/import/reviews.impex");
			...
			importImpexFile(context, "/abhrainctest/import/cstickets.impex");
		}
	}
}
