 ...
 * --- Generated at 13 Feb, 2017 12:02:22 PM                    ---
 * ----------------------------------------------------------------
 */
...
public abstract class GeneratedAbhraincFulfilmentProcessManager extends Extension
{
	...
	{
		return (Boolean)item.getProperty( ctx, AbhraincFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT);
	}
	...
	{
		return (EnumerationValue)item.getProperty( ctx, AbhraincFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE);
	}
