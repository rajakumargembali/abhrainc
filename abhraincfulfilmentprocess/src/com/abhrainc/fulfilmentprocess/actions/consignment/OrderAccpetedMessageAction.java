 ...
 *
 */
public class OrderAccpetedMessageAction extends AbstractAction<ConsignmentProcessModel>
{
	private static final Logger LOG = Logger.getLogger(OrderAccpetedMessageAction.class);
