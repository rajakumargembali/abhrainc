 ...
 *  
 */
package com.abhrainc.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, AbhraincFulfilmentProcessConstants.PARENT_PROCESS);
