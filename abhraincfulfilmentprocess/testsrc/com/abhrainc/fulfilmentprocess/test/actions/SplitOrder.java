 ...
 *  
 */
package com.abhrainc.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AbhraincFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AbhraincFulfilmentProcessConstants.PARENT_PROCESS);
