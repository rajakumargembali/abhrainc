 ...
 *  
 */
package com.abhrainc.cockpits.setup;
...
import com.abhrainc.cockpits.constants.AbhraincCockpitsConstants;
 ...
 */
@SystemSetup(extension = AbhraincCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(AbhraincCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(AbhraincCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						AbhraincCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/abhrainccockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
